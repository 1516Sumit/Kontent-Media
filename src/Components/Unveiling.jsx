            ...
            <section className="fade flex flex-col justify-center items-center">
                <div className="w-10/12">
                    ...
                    <div className="flex justify-center items-center sm:block" >
                        <div className="px-0 sm:p-2 h-3/4 bg-black flex justify-between items-start sm:items-center flex-col sm:flex-row">
                            {/* <div className="grid gap-12 md:grid-cols-3 md:gap-16 "> */}
                            <div className="pl-0 sm:pl-0 mt-10 sm:mt-0 flex justify-center items-center">
                            ...
                            <div className="pl-0 sm:pl-0 mt-20 sm:mt-0 flex justify-center items-center">
                                <div className="h-24 text-white border-[#7F00FF] border-t-0 border-l-4 border-r-0 border-b-0"></div>
                                <h2>
