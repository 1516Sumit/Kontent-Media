    ...
    return (
        <>
            <section className="h-auto bg-black w-screen">
                {/* <Unveiling/> */}
                <div className="fade bg-black flex justify-center sm:justify-start items-center">
                ...
                <div className="flex justify-center items-center sm:block" >
                    <div className="fade p-2 h-3/4 bg-black flex justify-evenly items-start sm:items-center flex-col sm:flex-row">
                ...
                <div className="h-auto lg:h-screen bg-black flex justify-evenly items-center flex-col text-white">
                    <div className="fade mt-20 flex justify-center items-center">
                        <h2 className="text-4xl lg:text-6xl xl:text-7xl" style={{ fontFamily: 'Archivo' }}>The Process</h2>
                    </div>
                    <div className="p-8 flex justify-center items-center text-center flex-wrap w-screen lg:flex-nowrap flex-col xl:flex-row">
                        <div className="flex justify-center items-center flex-col md:flex-row">
                            <div className="flex justify-center items-center flex-col md:flex-row">
                                <div className="fade flex justify-center items-center flex-col">
                                ...
                                <svg className="fade m-14 w-24 md:m-0 md:mb-12 md:w-32 lg:w-40 xl:w-52 rotate-90 md:rotate-0" xmlns="http://www.w3.org/2000/svg" width="209" height="39" viewBox="0 0 209 39" fill="none">
                                    <defs>
                            ...
                            <div className="fade flex justify-center items-center flex-col md:flex-row">
                                ...
                                <svg className="fade m-14 w-24 md:m-0 md:mt-40 xl:mt-0 xl:mb-24 md:w-32 lg:w-40 xl:w-52 rotate-90 xl:rotate-0" xmlns="http://www.w3.org/2000/svg" width="210" height="32" viewBox="0 0 210 32" fill="none">
                                    <defs>
                        ...
                        <div className="fade flex justify-center items-center flex-col md:flex-row-reverse lg:flex-row md:mt-20 xl:mt-0">
                            <div className="flex justify-center items-center flex-col md:flex-row-reverse lg:flex-row">
                                ...
                                <svg className="fade m-14 w-24 md:m-0 md:mt-0 md:mb-12 md:w-32 lg:w-40 xl:w-52 rotate-90 md:rotate-180 lg:rotate-0" xmlns="http://www.w3.org/2000/svg" width="206" height="32" viewBox="0 0 206 32" fill="none">
                                    <defs>
                    ...
                    <section className={type === "kontents2s" ? " " : "hidden"}>
                        <div className="p-8 mt-0 flex justify-center items-center text-center flex-wrap w-screen lg:flex-nowrap flex-row">
                            <div className="flex justify-center items-center flex-col-reverse md:flex-row-reverse lg:flex-row md:mt-20 lg:mt-0">
                                ...
                                <svg className="fade m-14 w-24 md:m-0 md:mt-0 md:mb-12 md:w-32 lg:w-40 xl:w-52 rotate-90 md:rotate-0 lg:rotate-180" xmlns="http://www.w3.org/2000/svg" width="206" height="32" viewBox="0 0 206 32" fill="none">
                                    <defs>
                                ...
                                <div className="fade flex justify-center items-center">
                                    <div className="flex justify-center items-center flex-col">
                                        <div className="w-16 h-16 bg-[#FFD93D] text-black rounded-full flex justify-center items-center">
                                            <h1 className="font-bold text-xl lg:text-2xl xl:text-3xl">5</h1>
                                        </div>
                                        <div className="p-2">
                                ...
                                <svg className="fade m-14 w-24 md:m-0 md:mb-52 lg:mt-0 lg:mb-32 md:w-32 lg:w-40 xl:w-52 rotate-90 md:rotate-45 lg:rotate-[145deg]" xmlns="http://www.w3.org/2000/svg" width="210" height="32" viewBox="0 0 210 32" fill="none">
                                    <defs>
