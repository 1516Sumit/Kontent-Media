    ...
    return (
        <>
            <section className="h-auto bg-black w-screen">
                            ...
                            <span className="flex justify-evenly items-center text-slate-900 text-3xl md:text-5xl font-extrabold mb-2">
                                <h2 className="ml-4">
                                    <span className="flex tabular-nums text-white text-3xl md:text-5xl font-extrabold  animate-[counter1_4s_ease-out_forwards] [counter-set:_num_var(--num)] before:content-[counter(num)]">
                                        <span className="sr-only">75,023,489</span><svg className="mt-3 ml-2 h-4 w-4 sm:h-6 sm:w-6 sm:mt-4 sm:ml-4" xmlns="http://www.w3.org/2000/svg" width="25" height="27" viewBox="0 0 25 27" fill="none">
                            ...
                            <span className="flex text-slate-900 text-3xl md:text-5xl font-extrabold mb-2">
                                <h2 className="ml-4">
                                    <span className="flex tabular-nums text-white text-3xl md:text-5xl font-extrabold  animate-[counter2_4s_ease-out_forwards] [counter-set:_num_var(--num)] before:content-[counter(num)]">
                                        <span className="sr-only">1,000,000</span><svg className="mt-3 ml-2 h-4 w-4 sm:h-6 sm:w-6 sm:mt-4 sm:ml-4" xmlns="http://www.w3.org/2000/svg" width="25" height="27" viewBox="0 0 25 27" fill="none">
                                            <path d="M24.8594 16.5803H15.8049V26.669H9.12534V16.5803H0.0213013V10.5468H9.12534V0.507568H15.8049V10.5468H24.8594V16.5803Z" fill="#FFD93D" />
                                        </svg>
                                    </span>
                                    <span className="inline-flex font-medium text-lg sm:text-xl text-slate-500">Followers</span>
                                </h2>
                            </span>
                        </h2>
                    </div>
                            ...
                            <span className="flex text-slate-900 text-3xl md:text-5xl font-extrabold mb-2">
                                <h2 className="ml-4">
                                    <span className="flex tabular-nums text-white text-3xl md:text-5xl font-extrabold  animate-[counter3_4s_ease-out_forwards] [counter-set:_num_var(--num)] before:content-[counter(num)]">
                                        <span className="sr-only">1800</span><svg className="mt-3 ml-2 h-4 w-4 sm:h-6 sm:w-6 sm:mt-4 sm:ml-4" xmlns="http://www.w3.org/2000/svg" width="25" height="27" viewBox="0 0 25 27" fill="none">
                                            <path d="M24.8594 16.5803H15.8049V26.669H9.12534V16.5803H0.0213013V10.5468H9.12534V0.507568H15.8049V10.5468H24.8594V16.5803Z" fill="#FFD93D" />
                                        </svg>
                                    </span>
                                    <span className="inline-flex font-medium text-lg sm:text-xl text-slate-500">Editing hrs</span>
                                </h2>
                            </span>
                        </h2>
                    </div>
                ...
                <div className="h-auto md:h-screen bg-black flex justify-evenly items-center flex-col text-white">
                    <div className="mt-20 flex justify-center items-center">
                        <h2 className="text-4xl lg:text-6xl xl:text-7xl" style={{ fontFamily: 'Archivo' }}>Edit Flow</h2>
                    </div>
                        ...
                        <div className="flex justify-center items-center flex-col md:flex-row">
                            <div className="flex justify-center items-center flex-col md:flex-row">
                                <div className="flex justify-center items-center flex-col">
                                    ...
                                    <div className="p-2">
                                        <h3 className="m-1 text-md lg:text-lg xl:text-xl" style={{ fontFamily: 'Archivo' }}>Research</h3>
                                        <h4 className="text-sm md:text-base text-slate-400">We do research before we start any projects</h4>
                                    </div>
                                </div>
                            ...
                            <div className="flex justify-center items-center flex-col md:flex-row">
                                <div className="flex justify-center items-center flex-col">
                                    ...
                                    <div className="p-2">
                                        ...
                                        <h4 className="text-sm md:text-base text-slate-400">Start editing according to the Research.</h4>
                                    </div>
                                </div>
                                {/* <div className="sparkWraper">
                        ...
                        <div className="flex justify-center items-center flex-col md:flex-row-reverse lg:flex-row md:mt-20 lg:mt-0">
                            <div className="flex justify-center items-center flex-col md:flex-row-reverse lg:flex-row">
                                <div className="flex justify-center items-center flex-col">
                                    ...
                                    <div className="p-2">
                                        <h3 className="m-1 text-md lg:text-lg xl:text-xl" style={{ fontFamily: 'Archivo' }}>Reviewing</h3>
                                        <h4 className="text-sm md:text-base text-slate-400">we makes sure your edit should first internal reviewed.</h4>
                                    </div>
                                </div>
                            ...
                            <div className="flex justify-center items-center">
                                <div className="flex justify-center items-center flex-col">
                                    ...
                                    <div className="p-2">
                                        <h3 className="m-1 text-md lg:text-lg xl:text-xl" style={{ fontFamily: 'Archivo' }}>Delivery</h3>
                                        <h4 className="text-sm md:text-base text-slate-400">After completing the Edit,
                                            Good to Go.</h4>
                                    </div>
                                </div>
                            </div>
