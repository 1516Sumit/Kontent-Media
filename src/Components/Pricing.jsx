                    ...
                    <div className="flex justify-center items-center my-10 sm:my-20 md:my-40 py-0 bg-[#7F00FF] w-screen h-auto md:h-128 overflow-hidden">
                        <div className='w-screen'>
                            ...
                            <div className="pricing grid grid-cols-1 md:grid-cols-3 justify-items-center items-center gap-10 sm:px-28 md:px-2 lg:px-16 md:gap-1 my-12 sm:m-12 md:m-0">
                                <div className="flex flex-col p-4 w-11/12 scale-[1.15] bg-white rounded-lg shadow xl:p-6 overflow-hidden z-10">
                                    ...
                                    <h1 className="p-2 text-2xl lg:text-3xl text-[#323133] font-extrabold">We Edit, You
                                        <br />Grow or Hit   <br />snooze on editing.</h1>
                                    <p className='p-2 text-sm text-slate-500'>Put out compelling videos across all platforms with<br/> quality edits in minimal time.Experience a dedicated<br/> Post-production team at your desk. </p>
