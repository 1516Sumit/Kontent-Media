...
function Keyfeature() {
    return (
        <>
            <div className="bg-black flex items-center justify-center flex-col w-screen h-auto mt-10 sm:mt md:mt-36 lg:mt-0">
                <div className="mt-0 sm:mt-56 md:mt-14 mb-2 md:mb-0 text-center">
                    <p className="fade self-center text-2xl sm:text-4xl md:text-5xl tracking-tight font-semibold whitespace-nowrap text-white" style={{ fontFamily: 'Archivo' }}>
                        Epic Videos.
                ...
                <div className="max-[480px]:mx-4 mx-10 mb-8 sm:mx-24 md:m-2 lg:m-6 grid grid-cols-1 lg:gap-24 md:grid-cols-3">
                    <div className="fade flex items-center justify-center flex-col  mb-4">
                        ...
                        <div className="h-12 m-2 p-3 pb-5 flex justify-start items-center flex-col text-center">
                            ...
                            <p className="text-white text-sm md:text-sm lg:text-base">Content Creation is a tedious process, not anymore.
                    ...
                    <div className="fade flex items-center justify-center flex-col mt-24 sm:mt-10 md:mt-0 mb-4">
                        ...
                        <div className="h-12 m-2 p-3 pb-5 flex justify-start items-center flex-col text-center">
                            ...
                            <p className="text-white text-sm md:text-sm lg:text-base">We help you create videos that sets you apart from the masses by personalizing branding & content psychology. We don’t  simply help you ride trends, but create them.
                    ...
                    <div className="fade flex items-center justify-center flex-col text-center mt-32 sm:mt-14 md:mt-0 mb-4">
                        ...
                        <div className="h-12 m-2 p-3 pb-5 flex justify-start items-center flex-col">
                            ...
                            <p className="text-white text-sm md:text-sm lg:text-base">Work with a team you can rely on.
