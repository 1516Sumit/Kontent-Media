        ...
        <>
            <div className="fade bg-black flex items-center justify-center flex-col w-screen h-auto md:h-screen">
                <div className="mt-0 sm:mt-56 md:mt-14 mb-2 md:mb-0 text-center">
                    ...
                    <p className="my-4 sm:my-10 mx-8 lg:my-5 font-Inter font-medium text-gray-400 sm:text-sm md:text-base lg:text-lg xl:text-xl sm:px-16 xl:px-48">200 Billion+ videos are played daily on social media.</p>
                </div>
                ...
                <div className="mx-10 sm:mx-24 md:m-2 lg:m-10 grid grid-cols-1 lg:gap-24 md:grid-cols-3">
                    <div className="flex items-center justify-center flex-col">
                        ...
                        <div className="h-12 m-2 p-3 pb-5 flex justify-center items-center flex-col text-center">
                            ...
                            <p className="text-slate-400 text-sm md:text-sm lg:text-base">Content Creation is time consuming , with us you just record and get rid off from all the Headaches , we will do the edits and distribute seamlessly for you.
                            </p>
                        </div>
                    </div>
                    <div className="flex items-center justify-center flex-col">
                    ...
                    <div className="flex items-center justify-center flex-col text-center">
                        ...
                        <div className="h-12 m-2 p-3 pb-5 flex justify-center items-center flex-col">
                            <h1 className="mb-5 text-white text-sm md:text-lg lg:text-xl">Forget Unreliable Teams</h1>
