            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2 px-8">
              ...
              <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 " id="navbar-default">
                ...
                <section className={second === "kontentedit" ? " " : "hidden"}>
                  <ul className="flex sm:justify-around flex-col p-4 md:p-0 mt-4 font-medium border border-black rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 bg-black md:bg-black">
                    <li>
                      <Link to="/Kontentedit" className="block py-2 pl-3 pr-4 text-gray-400 text-lg lg:text-2xl rounded md:hover:text-[#7F00FF] md:p-0 md:p-0" aria-current="page" style={{ fontFamily: 'Archivo' }}>Kontent Edit</Link>
                    </li>
                    <li>
                      <Link to="/Kontentpod" className="block py-2 pl-3 pr-4 text-gray-400 text-lg lg:text-2xl rounded md:hover:text-[#7F00FF] md:p-0 md:p-0" style={{ fontFamily: 'Archivo' }}>Kontent Pod</Link>
                    </li>
                    <li>
                      <Link to="/Kontents2s" className="block py-2 pl-3 pr-4 text-gray-400 text-lg lg:text-2xl rounded md:hover:text-[#7F00FF] md:p-0 md:p-0" style={{ fontFamily: 'Archivo' }}>Kontent S2S</Link>
                    </li>
                  </ul>
                </section>
              </div>
              <div className="hidden md:flex md:order-2">
                <section className={second === "kontentedit" ? " " : "hidden"}>
                <button type="button" className="m-2 text-black hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800  border-b-2 border-white-400 hover:border-purple-800" style={{ backgroundColor: '#FFFFFF', width: 127, height: 42, fontFamily: 'Archivo' }}><a href="#pricing">Pricing</a></button>
                </section>
                <button type="button" className="m-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800  border-b-2 border-white-400 hover:border-purple-800" style={{ backgroundColor: '#7F00FF', width: 127, height: 42, fontFamily: 'Archivo' }}><a href='#contactform'>Let’s Talk</a></button>
              </div>
            </div>
          </nav>
          {/* <section className={second === "kontentedit" ? " " : "hidden"}>
