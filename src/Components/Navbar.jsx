      ...
      {hamburger ? (
        ...
        <div className="sidebar text-center visible z-20">
          ...
          <section className={second === "kontentedit" ? "hidden" : ""}>
            ...
            <button type="button" className="m-2 mt-20 w-32 h-10 text-black bg-[#FFD93D] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0  border-b-2 border-white-400 hover:border-purple-800" style={{ fontFamily: 'Archivo' }}><a href='#contactform'>Let’s Talk</a></button>
          </section>
          <section className={second === "kontentedit" ? " " : "hidden"}>
            <li>
              {" "}
            ...
            <section className={second === "kontentedit" ? " " : "hidden"}>
              <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2 px-8">
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 " id="navbar-default">
                  <ul className="flex sm:justify-around flex-col p-4 md:p-0 mt-4 font-medium border border-black rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 bg-black md:bg-black">
                    <li>
                      <Link to="/Kontentedit" className="block py-2 pl-1 pr-2 lg:pl-3 lg:pr-4 text-gray-400 text-base lg:text-xl rounded md:hover:text-[#7F00FF] md:p-0 md:p-0" aria-current="page" style={{ fontFamily: 'Archivo' }}>Kontent Edit</Link>
                    </li>
                    <li>
                      <Link to="/Kontentpod" className="block py-2 pl-1 pr-2 lg:pl-3 lg:pr-4 text-gray-400 text-base lg:text-xl rounded md:hover:text-[#7F00FF] md:p-0 md:p-0" style={{ fontFamily: 'Archivo' }}>Kontent Pod</Link>
                    </li>
                    <li>
                      <Link to="/Kontents2s" className="block py-2 pl-1 pr-2 lg:pl-3 lg:pr-4 text-gray-400 text-base lg:text-xl rounded md:hover:text-[#7F00FF] md:p-0 md:p-0" style={{ fontFamily: 'Archivo' }}>Kontent S2S</Link>
                    </li>
                  </ul>
                </div>
                <div className="hidden md:flex md:order-2">
